...
When building Odin Recipes I focused on building out a simple and minimal UI by using basic HTML and CSS. The user will have a great experience while navigating through multiple pages of the website.

## Optimizations

If/when I improve this project, I would like to add hover affects and animations to make the site more appealing.

## Lessons Learned:

I learned basic HTML and CSS in order to build a fully functional website.
